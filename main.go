...
func main() {
	...
	app.Use(cors.New(cors.Config{
		AllowOrigins: "https://wahidinaji.github.io/fetch-api-with-github-page, https://kapalapi.takakiyo.my.id",
		...
		AllowHeaders: "Origin, Content-Type, Accept,Bearer,text/html; charset=utf-8",
